...
public class Affiche {
	...
	public static void AffichLicencie() {
		...
		Licencie l = null;
		try {
			l = new Licencie("Crapaud", "Nanard@letetard.net", "Bernard", 1580,
					230.8, datnais.parse(birthday), 2015);
	...
	public static void AffichPropr() {
		Proprietaire p = new Proprietaire("Le Bonobo", "MaxLaPoisse@Gmail.com",
				"Max", "07.07.07.07", "29 avenue de la Loose, 33000 Bordeaux");
		String mess = p.toString();
		System.out.print(mess);
	}

	public static void AffichCom() {
		Commissaire c = new Commissaire("Ducon", "stpénible@kikou.net",
				"Michel", "Bretagne");
